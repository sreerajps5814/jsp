...
if(z==1)
{
stmt.executeUpdate("update cart set total='"+cart_total+"',quantity='"+quantity+"' where product_id='"+product_id+"'and email='"+emailid+"' and adress is NULL");
response.sendRedirect("home.jsp?msg=exist");

}
if(z==0)
{
PreparedStatement stsmt=con.prepareStatement("insert into cart(email,product_id,quantity,product_price,product_total)values(?,?,?,?,?)");	
